...
### Наступний крок для власника

Той самий процес, що й раніше: скопіювати оновлений
`physical-boot-probe.img` на Ventoy-флешку, завантажити на реальному
GA-H170-Gaming 3, перевірити рядок `Boot Guard MSR` і особливо
`verified_boot=` у виводі. **Якщо `verified_boot=1`** — вставку
власного DXE-модуля в прошивку не варто робити без набагато глибшого
дослідження (чи навіть варто відкладати) — CPU відхилить непідписаний
образ на рівні ACM. **Якщо `verified_boot=0`** — шлях до вставки DXE-
модуля відкритий для продовження.
